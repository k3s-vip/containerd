...
// defaultMetadataVersion is the default version of container metadata used by MarshalJSON
var defaultMetadataVersion = metadataVersion1
...
func (c *Metadata) MarshalJSON() ([]byte, error) {
	m, err := metadataToInternal(*c, defaultMetadataVersion)
	if err != nil {
		return nil, err
	}
